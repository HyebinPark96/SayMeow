...
public class GmailSend {
	...
	private static class SMTPAuthenticator extends Authenticator {
		public PasswordAuthentication getPasswordAuthentication() {
			return new PasswordAuthentication("seoha.mailing", "pwdformailing!!");
		}
	}
	
	// Static 메소드(정적 메소드) : 객체 생성없이 호출 가능
	public static void send(String title, String content, String toEmail) {
		...
		try {
			...
			Address fromAddr = new InternetAddress("chjin195@gmail.com"); 
	...
	public static void main(String[] args) {
		...
		String content = "내용2";
		// 본인이 확인가능한 이메일
		String toEmail = "bini2718@naver.com"; 
